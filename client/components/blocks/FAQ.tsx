...
const items = [
  {
    id: '1',
    title: 'What makes Algorand different?',
    content:
      'Algorand is a fully open-source, developer-first component library built using Next.js and TailwindCSS, designed to help you launch your MVPs in record time. No bloated packages, no unnecessary installs—just clean, copyable code to plug right into your next big thing.',
  },
  {
    id: '2',
...
export default function Faq1() {
  return (
    <section className="py-12 md:py-16 bg-blue-1000 dark:bg-blue-950">
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        <div className="mb-10 text-center">
          ...
          <motion.p
            className="mx-auto max-w-2xl text-black dark:text-slate-300"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            Everything you need to know about Algorand and how to use our
            ...
            {items.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  <AccordionContent
                    className={cn(
                      'text-black dark:text-slate-300 overflow-hidden pt-0 pb-4',
